...
# docker build
docker build -t shenhailuanma/minitranscoder:1.0.10 .

# run service
# docker run -p 9003:9000 -d shenhailuanma/minitranscoder:1.0.10

# push 
# docker push shenhailuanma/minitranscoder:1.0.10